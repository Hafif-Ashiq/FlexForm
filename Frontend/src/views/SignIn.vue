              ...
              <div class="mt-8 card card-plain">
                ...
                <div class="card-body">
                  <form role="form" class="text-start" @submit.prevent="() => handleSignin()">
                    <label>Email</label>
                    <soft-input id="username" type="email" placeholder="Email" name="email" v-model="email" />
                    <label>Password</label>
                    <soft-input id="password" type="password" placeholder="Password" name="password" v-model="password" />
                    <soft-switch id="rememberMe" name="rememberMe" checked>
                      Remember me
                    </soft-switch>
                    <div class="text-center">
                      <soft-button class="my-4 mb-2" variant="gradient" color="success" full-width
                        @click="() =>handleSignin">Sign in
                      </soft-button>
                    </div>
                  </form>
                </div>
